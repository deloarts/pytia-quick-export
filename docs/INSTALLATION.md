...
Click it and then select the encapsuled python from the following folder `C:\pytia\pytia-quick-export\.env\Scripts\python.exe`. Keep in mind that your pytia-folder may be located somewhere else.
